...
import { LayoutDashboard, CheckSquare, Users, Package } from 'lucide-react'
import Navbar from './Navbar'
import clsx from 'clsx'

const links = [
  { to: '/admin', label: 'Vue d\'ensemble', icon: LayoutDashboard, end: true },
  { to: '/admin/tailors', label: 'Couturières', icon: CheckSquare },
      ...
      <div className="flex pt-16">
        <aside className="w-60 min-h-screen bg-charcoal border-r border-gold/10 fixed left-0 top-16 hidden md:block">
          <div className="p-4 border-b border-gold/10">
            <span className="font-ui text-xs tracking-widest uppercase text-gold">Administration</span>
          </div>
